...
`,
    ...
    hiddenTests: [
      ...
      { id: "t3", name: "styles cards", patterns: [/\.summary__card\s*\{[^}]*[a-z-]+\s*:/] },
      { id: "t4", name: "highlights balance", patterns: [/\.summary__balance\s*\{[^}]*[a-z-]+\s*:/] },
...
`,
    ...
    hiddenTests: [
      ...
      { id: "t2", name: "styles inputs", patterns: [/\.transfer__field(?:\s+input|\s*\{[^}]*input)[^}]*[a-z-]+\s*:|input[^{]*\{[^}]*[a-z-]+\s*:/] },
      { id: "t3", name: "styles button", patterns: [/\.transfer__submit\s*\{[^}]*[a-z-]+\s*:/] },
...
`,
    ...
    hiddenTests: [
      ...
      { id: "t4", name: "primary styles", patterns: [/\.otp__primary\s*\{[^}]*[a-z-]+\s*:/] },
      { id: "t5", name: "no frameworks", patterns: [/./], forbidden: [/@tailwind|bootstrap|bds-/i] },
    ],
