    ...
    topics: [
      {
        ...
        bankLinks: ["w-box-sizing", "css-account-summary", "css-transfer-form"],
      ...
      },
      {
        ...
        bankLinks: ["w-semantic-html", "css-otp-banner", "css-movements-list"],
      },
      {
        id: "css-flexbox",
        ...
        keyPoints: [
          ...
          "`flex: 1` reparte espacio; `gap` > margins sucios.",
          "`align-self` para un hijo rebelde.",
        ],
        bankLinks: ["w-flex-gap", "css-transfer-form", "css-account-summary", "css-otp-banner"],
      ...
      },
      {
        ...
        summary: "Layouts 2D: cards, dashboards, product grids.",
        keyPoints: [
          "`grid-template-columns: repeat(auto-fit, minmax(...))`.",
          "`gap` funciona igual que en flex.",
          "`fr` = fracción del espacio libre.",
          "`grid-column: span 2` para héroes.",
          "Áreas con `grid-template-areas` (opcional).",
        ],
        bankLinks: ["w-grid-autofit", "css-product-cards", "css-account-summary"],
      },
      {
        id: "css-position-z",
        ...
        keyPoints: [
          ...
          "Cuidado: overflow:hidden puede ‘cortar’ sticky.",
        ],
        bankLinks: ["w-position-sticky", "css-otp-banner", "css-movements-list"],
      },
      {
      ...
      },
      {
        ...
        bankLinks: ["css-movements-list", "css-product-cards", "css-transfer-form", "w-a11y-button"],
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        bankLinks: ["w-trackby", "w-ngfor-async", "ng-checklist-groups", "js-format-currency"],
      },
    ],
  },
  {
