...
const rawStudyTracks: RawStudyTrack[] = [
  {
    ...
    topics: [
      ...
      },
      {
        ...
        remember: "PATCH DTO = Partial<Pick<…>>.",
      },
      {
        ...
        summary: "Ejercicios de código típicos de prueba técnica (resultado + completar).",
        keyPoints: [
          "Curry acumula args hasta `fn.length`.",
          "Closures: contadores independientes por factory.",
          "HOF: withLog, debounce, compose.",
          "Partial application: `multiply(2)(5) === 10`.",
        ],
        bankLinks: [
          "ts-curry-complete",
          "ts-closure-result",
          "ts-hof-map",
          "ts-partial-apply-output",
          "f-closure",
        ],
    ...
    topics: [
      {
        ...
        bankLinks: ["w-box-sizing", "css-box-model-content", "css-box-border-box", "css-account-summary"],
      ...
      },
      {
        ...
        bankLinks: ["w-display-flow", "css-display-inline-block", "css-display-none-vs-hidden"],
      },
      {
        id: "css-flexbox",
      ...
      },
      {
        ...
        bankLinks: ["w-em-vs-rem", "css-account-summary", "css-product-cards"],
      },
      {
        ...
        bankLinks: ["w-css-specificity", "w-pure-css-no-tailwind", "w-no-bds"],
      ...
      },
      {
        ...
        bankLinks: ["w-pseudo-media", "css-media-mobile-first", "css-product-cards", "css-transfer-form"],
      },
      {
    ...
    topics: [
      {
        ...
        bankLinks: ["w-ngonchanges", "w-hostlistener", "ng-todo-tabs", "ng-transaction-filter"],
      ...
      },
      {
        ...
        bankLinks: ["w-ngonchanges", "w-template-ref", "ng-tabs-products", "ng-otp-input"],
      },
      {
        id: "ng-signals",
        ...
        bankLinks: ["w-onpush", "ng-todo-tabs", "ng-checklist-groups", "ng-transaction-filter"],
      ...
      },
      {
        ...
        bankLinks: ["w-onpush", "w-trackby", "w-ngfor-async", "ng-transaction-filter"],
      },
      {
        ...
        bankLinks: ["ng-todo-tabs", "ng-tabs-products", "ng-otp-input", "ng-checklist-groups"],
      },
      {
      ...
      },
      {
        ...
        bankLinks: ["w-trackby", "w-ngfor-async", "w-ngif-directive", "ng-code-ngfor-trackby", "ng-checklist-groups"],
      },
      {
        ...
        bankLinks: [
          "ng-guard-canactivate-scenario",
          "ng-guard-candeactivate-form",
          "ng-guard-canmatch-lazy",
          "ng-guard-resolve-prefetch",
          "ng-guard-order-trap",
          "ng-code-subscribe-leak-guard",
        ],
    ...
    topics: [
      {
        ...
        keyPoints: [
          ...
          "Orden real Bancolombia: Angular API → 5 AWS → 5 HTML/CSS (Grid) → TypeScript curry → 5 Angular MCQ.",
          "Hasta 15 slots de práctica; prioriza contenido no visto.",
          "En celular: solo MCQ; prácticas de código en PC.",
        ],
        bankLinks: ["ng-sports-results", "js-curry", "aws-rds-managed-db"],
      },
    ],
  },
];
